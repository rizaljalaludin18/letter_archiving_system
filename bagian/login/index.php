 ...
 <main>
  ...
  <div class="wrapper">
    <form action="proses_login.php" id="login" name="login" method="post" class="form-signin">
      ...
      <input type="text" class="form-control" id="username" name="username_admin_bagian" placeholder="Email Address" required="" autofocus="" />
      <input type="password" class="form-control" id="password" name="password_bagian" placeholder="Password" required=""/>      
